...
namespace NerdStore.Vendas.Domain.Tests
{
    public class PedidoTests
    {
        ...
        [Trait("Categoria", "Vendas - Pedido")]
        public void AdicionarItemPedido_UnidadesItemAcimaPermitido_DeveRetornarException()
        {
            // Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var produtoId = Guid.NewGuid();
        ...
        [Trait("Categoria", "Vendas - Pedido")]
        public void AtualizarItemPedido_ItemExisteNaLista_DeveRetornarException()
        {
            // Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        ...
        public void AtualizarItemPedido_ItemValido_DeveAtualizarQuantidade()
        {
            ...
            // Assert
            Assert.Equal(novaQuantidade, pedido.PedidoItems.FirstOrDefault(c => c.ProdutoId == produtoId).Quantidade);
        }

        [Fact(DisplayName = "Atualizar item Pedido Validar Total")]
        [Trait("Categoria", "Vendas - Pedido")]
        public void AtualizarItemPedido_PedidoComProdutosDiferentes_DeveAtualizarTotal()
        {
            // Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var produtoId = Guid.NewGuid();
        ...
        [Fact(DisplayName = "Atualizar item Pedido Quantidade Acima do permitod")]
        [Trait("Categoria", "Vendas - Pedido")]
        ...
        public void Pedido_AplicarVoucherInvalido_DeveRetornarComErros()
        {
            ...
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var voucher = new Voucher("PROMO-15-REAIS", null, 15, 1,
                TipoDescontoVoucher.Valor, DateTime.Now.AddDays(15), true, true);
